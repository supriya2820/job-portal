...
const JobListing = () => {
    ...
    useEffect (()=>{
        const mathchesCategory = job => selectedCategories.length === 0 || selectedCategories.includes(job.category) 
        ...
        const newFilteredJobs =jobs.slice().reverse().filter(
            job => mathchesCategory(job) && matchesLocation(job) && matchesTitle(job) && matchesSearchLocation(job)
        )
